...
export const ActionsList: FC<any> = () => {
    ...
    const filterActions = () => {
        return actions
            .filter((action: ActionItemT) =>
                showComplete ? true : !action.isCompleted
            )
            .sort((a: ActionItemT, b: ActionItemT) => {
                ...
                switch (selected.selected) {
                    case "Date":
                        ...
                        break;
                    case "AOI":
                        comparison = b.areaOfImportance.localeCompare(
                            a.areaOfImportance
                        );
                        break;
                    case "Time":
    ...
    return (
        <View style={styles.container}>
            ...
            />
            <AreasOfImportance
                modalVisible={aoiModal}
                setModalVisible={setAoiModal}
            />
        </View>
    );
};
